...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/sercan/capstone/username')
    password_param = ssm.get_parameter(Name="/sercan/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cluijcqqhgkx.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-sercan-blog' # please enter your s3 bucket name
